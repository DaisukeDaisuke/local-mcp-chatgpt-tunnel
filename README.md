...
| `codespace` | `list_codespaces`、`roots`、`git_root`、`search_text`、`ssh`、`copy_to_codespace`、`stop_codespace`、`open_port`、`close_port` | 既存GitHub Codespaceだけを対象に、remote検索・SSH・転送・停止・GitHub-hosted preview port公開を行う。Codespace作成ツールは持たない |
